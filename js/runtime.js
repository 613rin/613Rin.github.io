...
function createtime(){
    ...
    var e=new Date("09/08/2024 00:00:00"),
        t=Math.trunc(234e8+(now-e)/1e3*17),
        a=(t/1496e5).toFixed(6),
        o=new Date("09/09/2024 00:00:00"),
    ...
    c = s<18 && s>=9 
        ? `<br> <div style="font-size:13px;font-weight:bold">砂糖橘水果店开门了 ${r} 天 ${s} 小时 ${l} 分 ${b} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${t} 千米，约为 ${a} 个天文单位 🚀</div>`
